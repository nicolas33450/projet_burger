                ...
                <section class="content">
                    ...
                    if(isset($_POST['envoyer']))
                    {
                        ...
                        { 
                            ...
                            $requete->bindValue(':email', $e);
                            $requete->bindValue(':tel', $t);
                            $requete->bindValue(':login', $l);
                            $requete->bindValue(':mdp', $m);
                            $requete->bindValue(':date_anniv', $dn);
                            $requete->bindValue(':role', $r);
